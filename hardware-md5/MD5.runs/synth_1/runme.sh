...
HD_PWD='C:/Users/catar/Desktop/git/md5-hardware/hardware-md5/MD5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log md5Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source md5Demo.tcl
