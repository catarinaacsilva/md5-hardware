...
HD_PWD='C:/Users/catar/Desktop/git/md5-hardware/hardware-md5/MD5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log md5Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source md5Demo.tcl -notrace
