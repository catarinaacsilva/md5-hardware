...
HD_PWD='c:/users/catar/desktop/git/md5-hardware/md5demo/md5demo.tmp/md5hf_v1_0_project/MD5HF_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MD5HF_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MD5HF_v1_0.tcl
